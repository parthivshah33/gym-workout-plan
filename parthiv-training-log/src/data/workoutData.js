...
export const progressData = {
  labels: ['05 Mar', '08 Apr', '20 Jul', '16 Sep'],
  kpis: [
    { value: '74', unit: 'kg', delta: '▼ 1.1kg', direction: 'down', label: 'Weight' },
    { value: '23.7', unit: '%', delta: '▼ 1.7%', direction: 'down', label: 'Body Fat' },
    { value: '30', unit: 'cm', delta: '▼ 7cm', direction: 'down', label: 'Waist' },
  ],
  charts: [
    { title: 'Weight (kg)', data: [75.7, 75.7, 75.1, 74], color: '#8b9099' },
    { title: 'Body Fat (%)', data: [25.4, 25.2, 23.7], color: '#6fae7f' },
    { title: 'Waist (cm)', data: [37, 36, 30], color: '#c4453a' },
  ],
  measurements: {
    headers: ['Metric', '05 Mar', '08 Apr', '20 Jul', '16 Sep'],
    rows: [
      ['Weight (kg)', '75.7', '75.7', '75.1', '74'],
      ['BMI', '25.1', '25.1', '~24.9', '~24.5'],
